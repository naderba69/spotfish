...
# إعداد واجهة المستخدم لتناسب الهواتف والكمبيوتر
...
def process_fishing_analysis(latitude, longitude):
    try:
        # تصحيح الروابط وضمان صياغة الـ f-string هندسياً بدون فراغات مضللة
        ...
        # خط الدفاع الثاني المصلح في حال الضغط بالخطأ على اليابسة (تفعيل محاكاة الرياح الساحلية)
        try:
